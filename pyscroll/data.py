...
class TiledMapData(PyscrollDataAdapter):
    ...
    def __init__(self, tmx: pytmx.TiledMap):
...
class MapAggregator(PyscrollDataAdapter):
    ...
    def __init__(self, tile_size: Vector2DInt):
        super().__init__()
        self.tile_size = tile_size
        self.map_size: Vector2DInt = (0, 0)
        self.maps: list[tuple[PyscrollDataAdapter, pygame.Rect]] = list()
        self._min_x = 0
        self._min_y = 0
